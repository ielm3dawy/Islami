...
import 'package:islami/moduls/quran/widgets/sura_title_widget.dart';
            ...
            itemBuilder: (context, index) => InkWell(
              onTap: () {
                Navigator.pushNamed(
                  ...
                  arguments: SuraData(
                    surName: suraNames[index],
                    surNumber: (index + 1).toString(),
                  ),
                );
              },
              child: SuraTitleWidget(
                suraName: suraNames[index],
                suraVerses: versesNumber[index].toString(),
              ),
            ),
